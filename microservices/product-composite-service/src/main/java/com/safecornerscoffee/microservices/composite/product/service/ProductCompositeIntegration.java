...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
    ...
    public Product createProduct(Product body) {
        try {
            ...
            LOG.debug("Created a product with id: {}", product != null ? product.getProductId() : "Reference Null Object");
    ...
    public Product getProduct(int productId) {
        try {
            ...
            LOG.debug("Found a product with id: {}", product != null ? product.getProductId() : "Reference Null Object");
    ...
    public Recommendation createRecommendation(Recommendation body) {
        try {
            ...
            LOG.debug("Created a recommendation with id: {}", recommendation != null ? recommendation.getProductId() : "Reference Null Object");
    ...
    public Review createReview(Review body) {
        try {
            ...
            LOG.debug("Created a review with id: {}", review != null ? review.getProductId() : "Reference Null Object");
